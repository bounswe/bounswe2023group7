...
const EditGroupForm = ({ group, game }) => {
    ...
    const [member, setMember] = useState(group?.maxNumberOfMembers || 0);
        ...
        <Box sx={{ display: "flex", justifyContent: "center" }}>
            ...
            >
                ...
                <Grid item xs={12} spacing={1}>
                    ...
                    <TextField
                        defaultValue={group?.maxNumberOfMembers}
