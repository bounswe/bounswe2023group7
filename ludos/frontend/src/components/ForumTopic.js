...
*/
  ...
  return (
    ...
    style={{display: "flex", flexDirection: "row", width: "100%", maxHeight: "150px"}}>
                <Grid style={{ 
                    display: "flex", 
                    ...
                    alignItems: "center",
                        ...
                        src={data.topic.imgsrc || "https://p7.hiclipart.com/preview/173/464/909/clip-art-pokeball-png.jpg"}
                            />
                ...
                <Grid style={{ 
                    ...
                    width: "100%",
                      ...
                      >
                        ...
                        <Grid style={{display: "flex", flexDirection: "column", justifyContent: "flex-end", paddingTop: "15px" }}>
                            <div style={{
                                width: "94%",
                                height: "1px",
